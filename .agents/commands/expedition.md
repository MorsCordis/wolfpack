...
Alpha reads TODO.md, the description, and the codebase to propose a sequence of hunts. Each hunt gets a slug, description, tier, mode, wave assignment, dependencies, and a trigger command.

## Steps

1. Parse arguments: `[--no-review] [--max-hunts=N] <campaign-slug> "<description>"`
2. Read TODO.md, CHANGELOG.md, and relevant source files
